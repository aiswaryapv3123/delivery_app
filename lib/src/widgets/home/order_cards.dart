                                  ...
                                  child: Column(
                                    children: [
                                      OrderTile(
                                        ...
                                        value: "\$" +
    (widget.orderData.payment!.price! + widget.orderData.deliveryFee!).toStringAsFixed(2),
                                        preparing:
                                      ...
                                      widget.orderData.orderStatus!.status!.index == 2
                                        ...
                                        OrderTile(
                                          label: "Total",
                                          fontSize: 16,
                                          value: (widget.orderData.payment!.price! + widget.orderData.deliveryFee!).toString(),
                                          preparing: widget.orderData.orderStatus!
                                              .status!.index ==
                                              2
                                              ? true
