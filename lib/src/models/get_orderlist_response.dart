...
// import 'dart:convert';
//
// GetOrderList getOrderListFromJson(String str) => GetOrderList.fromJson(json.decode(str));
//
// String getOrderListToJson(GetOrderList data) => json.encode(data.toJson());
//
// class GetOrderList {
//   GetOrderList({
//     this.success,
...
//     deliveryAddressId: json["delivery_address_id"] == null ? null : json["delivery_address_id"],
...
//     "active": active,
//     "driver_id": driverId,
//     "delivery_address_id": deliveryAddressId == null ? null : deliveryAddressId,
...
enum AddressEnum { KORATTY_680309_INDIA, ELANJIPRA_680721_INDIA, CHALAKUDY_680307_INDIA, PURATHUR_676102_INDIA }

final addressEnumValues = EnumValues({
  "Chalakudy, 680307, India": AddressEnum.CHALAKUDY_680307_INDIA,
  "Elanjipra, 680721, India": AddressEnum.ELANJIPRA_680721_INDIA,
  "Koratty, 680309, India": AddressEnum.KORATTY_680309_INDIA,
  "Purathur, 676102, India": AddressEnum.PURATHUR_676102_INDIA
});
...
class CustomFields {
  ...
  final AddressClass? phone;
  final AddressClass? bio;
  final AddressClass? address;
  final AddressClass? verifiedPhone;

  factory CustomFields.fromJson(Map<String, dynamic> json) => CustomFields(
    phone: AddressClass.fromJson(json["phone"]),
    bio: AddressClass.fromJson(json["bio"]),
    address: AddressClass.fromJson(json["address"]),
    verifiedPhone: AddressClass.fromJson(json["verifiedPhone"]),
  );
...
enum OrderStatusStatus { PREPARING, ON_THE_WAY, DELIVERED }

final orderStatusStatusValues = EnumValues({
  "Delivered": OrderStatusStatus.DELIVERED,
  "On the Way": OrderStatusStatus.ON_THE_WAY,
  "Preparing": OrderStatusStatus.PREPARING
});
...
enum PaymentStatus { WAITING_FOR_CLIENT, PAID }
